...
function MemberPreview(props) {
    ...
    return (
        <a className={`member-preview ${props.member.boosting ? 'premium-border' : default_border} ${props.className !== undefined ? props.className : ''}`} href={`/stats/members/${props.member.id}`}>
